...
@interface CannotLoginViewController ()<UITableViewDelegate, UITableViewDataSource>
@property (nonatomic, assign) CannotLoginMethodType medthodType;
@property (nonatomic, assign) NSUInteger stepIndex;
@property (nonatomic, strong) NSString *userStr, *phoneCode, *password, *confirm_password, *j_captcha;

@property (strong, nonatomic) TPKeyboardAvoidingTableView *myTableView;
@property (nonatomic, strong) UIButton *footerBtn;
@property (nonatomic, strong) NSString *phoneCodeCellIdentifier;
@end
...
- (void)footerBtnClicked:(id)sender {
    ...
    if (_stepIndex == 0) {
        ...
        if (_medthodType == CannotLoginMethodPhone) {
            ...
            NSMutableDictionary *params = @{@"account" : _userStr, @"password" : [_password sha1Str], @"confirm" : [_confirm_password sha1Str], @"code" : _phoneCode}.mutableCopy;
