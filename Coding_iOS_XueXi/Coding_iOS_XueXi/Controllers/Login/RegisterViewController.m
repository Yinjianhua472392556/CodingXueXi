...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (_medthodType == RegisterMethodEamil) {
        cellIdentifier = (indexPath.row == 3? kCellIdentifier_Input_OnlyText_Cell_Captcha :
                          indexPath.row == 2? kCellIdentifier_Input_OnlyText_Cell_Password : kCellIdentifier_Input_OnlyText_Cell_Text);
    }else {
        cellIdentifier = (indexPath.row == 4? kCellIdentifier_Input_OnlyText_Cell_Captcha :
                          ...
                          indexPath.row == 1? kCellIdentifier_Input_OnlyText_Cell_Phone : kCellIdentifier_Input_OnlyText_Cell_Text);
    }
